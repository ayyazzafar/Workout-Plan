...
const EditModal: React.FC<EditModalProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<
    ...
    | "restday"
  >("person");
  const [expandedWorkoutSections, setExpandedWorkoutSections] = useState<Set<string>>(
          ...
          {activeTab === "workouts" && (
            <div className="edit-section">
              ...
              <p className="section-note">
                Edit all workout details for each day
              </p>

                <div className="workout-detailed-edit">
                  {Object.entries(formData.workouts).map(([dayKey, workout]) => (
                    <div key={dayKey} className={`workout-day-editor ${expandedWorkoutSections.has(dayKey) ? 'expanded' : 'collapsed'}`}>
                      <div 
                      ...
                      >
                        ...
                        <div className="workout-section-controls">
                          ...
                          <svg
                            className={`expand-chevron ${expandedWorkoutSections.has(dayKey) ? 'rotated' : ''}`}
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
                    ...
                    <div className="exercises-section">
                      ...
                      <div className="exercises-list">
                        {workout.exercises.map((exercise, exerciseIndex) => (
                          <div key={exerciseIndex} className="exercise-editor">
